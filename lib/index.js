(function (global, factory) {
  ...
  function array2tree(array) {
    ...
    var _Object$assign = Object.assign({
      ...
      parentRefKey: false
        ...
        parentRefKey = _Object$assign.parentRefKey;
    ...
    Array.isArray(array) && array.forEach(function (item) {
      ...
      hasOwnProperty.call(nodeMap, item[pid]) && nodeMap[item[pid]][children].push(Object.assign(nodeMap[item[id]], pRefKey ? _defineProperty({}, pRefKey, nodeMap[item[pid]]) : {}));
  ...
  function mapToObject(objectArray) {
    ...
    Array.isArray(objectArray) && keyProp && valueProp && [keyProp, valueProp].every(function (val) {
      ...
      ['string', 'number'].includes(_typeof(key)) && (result[key] = value);
    });
    return result;
  ...
  function checkoutBy(object, keys, mergeFn) {
    ...
    if (Array.isArray(keys)) {
      ...
      return Object.keys(keys).map(function (item) {
        return object[item] instanceof Object && keys[item] instanceof Object ? mergeFn ? mergeFn({}, object[item], keys[item]) : Object.assign({}, object[item], keys[item]) : keys[item] || object[item];
      });
    }
